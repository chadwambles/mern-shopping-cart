...
import { filterByOwner } from "./api";
import { Redirect, Link } from "react-router-dom";
import DeleteShopPage from "./DeleteShopPage";
          ...
          <span className={cssprops.addButton}>
            <Link to="/seller/shop/new">
              <Button color="primary" variant="contained">
                <Icon className={cssprops.leftIcon}>add_box</Icon> New Shop
              </Button>
            </Link>
          </span>
        </Typography>
            ...
            return (
              <span key={i}>
                <ListItem button>
                  ...
                  />
                  {auth.isAuth().user &&
                    auth.isAuth().user._id == shop.owner._id && (
                      <ListItemSecondaryAction>
                        ...
                        <DeleteShopPage shop={shop} onRemove={removeShop} />
                      </ListItemSecondaryAction>
                    )}
                </ListItem>
                <Divider />
